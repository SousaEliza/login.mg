...
export class EmailValidator {
    static validate(email) {
        ...
        return {
            ...
            message: emailRegex.test(email) ? '' : 'Please, insert a valid e-mail address'
        };
    }
}
...
export class PasswordValidator {
    ...
    static validateConfirmation(password, confirmPassword) {
        ...
        return {
            isValid,
            message: isValid ? 'Thanks for confirming your password' : 'Passwords does not match'
        };
    }
}
...
export class FormValidator {
    ...
    static validateRegistrationForm(name, email, password, confirmPassword) {
        ...
        if (!confirmPassword) {
            ...
            const confirmValidation = PasswordValidator.validateConfirmation(password, confirmPassword);
